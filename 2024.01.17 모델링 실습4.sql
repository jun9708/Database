...
('user1','김유신','1976-01-21','M','010-1101-1976','kimys@naverm.com','0','1','서울','2022-01-10 10:50:12'),
('user2','계백','1976-06-11','M','010-1102-1975', null,'1000','1','서울','2022-01-10 10:50:12'),
('user3','김춘추','1989-05-30','M','010-1103-1989', null,'1200','2','서울','2022-01-10 10:50:12'),
('user4','이사부','1979-04-13','M','010-2101-1979','leesabu@gamil.com','2600','1','서울','2022-01-10 10:50:12'),
...
('user8','신사임당','1965-10-21','M','010-5101-1965','sinsa@gamil.com','1500','1','대구','2022-01-10 10:50:12'),
...
('2','user2','6000','상품구매 5% 적립','2022-01-10 10:50:12'),
('3','user3','2835','상품구매 5% 적립','2022-01-10 10:50:12'),
('4','user4','3610','상품구매 5% 적립','2022-01-10 10:50:12'),
('5','user5','3000','이벤트 응모 3000 적립','2022-01-10 10:50:12'),
('6','user6','1000','회원가입 1000 적립','2022-01-10 10:50:12'),
('7','user7','2000','이벤트 응모 2000 적립','2022-01-10 10:50:12'),
('8','user8','2615','상품구매 5% 적립','2022-01-10 10:50:12'),
('9','user9','1500','이벤트 응모 1500 적립','2022-01-10 10:50:12'),
('10','user10','15840','상품구매 2% 적립','2022-01-10 10:50:12');
...
('22010310001','user5','127000','경기도 광쥐 초월로 21','1','2022-01-10 10:50:12'),
...
#문제1 (모든 장바구니 내역에서 고객명, 상품명, 상품수량을 조회하시오. 단 상품수량 2건이상만 조회 할것)
...
#문제2 (모든 상품내역에서 상품번호, 카테고리명, 상품명, 상품가격, 판매자이름, 판매자 연락처를 조회하시오)
...
#문제5 (모든 주문의 주문번호, 주문자 아이디, 고객명, 상품명, 상품일자를 조회하시오 주문번호는 중복없이 상품명은 구분자, 로 나열할것)
select 
distinct a.`orderno`, d.`userid`, `username`,
...
GROUP BY a.`orderno`, d.`userid`, `username`;
...
#문제9 (모든 주문상세내역 중 개별 상품 가격과 개수 그리고 할인율이 적용된 가격을 구하고 그 가격으로 주문별 총합을 구해서 주문별 총합이 10만원이상 그리고 큰 금액순으로 `주문번호`, `최종총합`을 조회하시오)
select 
	`orderNo`,
    SUM(`할인가`) as `최종총합`
from 
...
select `orderno`,
		sum(floor(`itemPrice` * (1-`itemdiscount` /100 ) * `itemCount` )) as `최종통합`
from `orderItem`
group by `orderno`
having `최종통합` >= 10000
order by `최종통합` desc;
